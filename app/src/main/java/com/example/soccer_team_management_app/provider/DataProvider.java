package com.example.soccer_team_management_app.provider;
...
public class DataProvider {
    // Example Teams Data
    // These are static methods because they do not need instances of the DataProvider class to be invoked.
    public static List<Team> createSampleTeams() {
        ...
        teams.add(new Team("6","Ajax Amsterdam", "Netherlands", "Eredivisie", "Johan Cruyff Arena",
                1900));
